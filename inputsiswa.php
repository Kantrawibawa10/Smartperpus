                      ...
                      <?php
                        ...
                        <tr>
                            ...
                            <td style="display: flex;">
                                ...
                                <!--deleted-->
                                <a href="admin.php?halaman=siswa&id_siswa=<?php echo $data['id_siswa']; ?>" class="icon-aksi"><i class="fa fa-trash bg-danger" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                      </tbody>
    ...
    <?php
        if(isset($_POST['tambah'])){
            ...
            if(mysqli_num_rows($cek) == 0){
              ...
              if($sql){
                echo '<script>alert("Berhasil menambahkan data."); document.location="admin.php?halaman=siswa";</script>';
              }else{
    ...
    <!------------------------------------------------------------------------------------------------------------------------------------
        ...
        if(isset($_POST['edit'])){
          ...
          else
          {
            ...
            if($query){
                echo "<script>alert('Berhasil Mengubah Data!'); window.location.href='admin.php?halaman=siswa';</script>";
            }else{
