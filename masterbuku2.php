                  ...
                  ?>
                    <tr>
                        ...
                        <td class="d-flex">
                          ...
                          <!--deleted-->
                          <a href="petugas.php?halaman=buku&kode_buku=<?= $data['kode_buku']; ?>" class="icon-aksi"><i class="fa fa-trash bg-danger" aria-hidden="true"></i></a>
                          <!--deleted end-->
                        </td>
                    </tr>
                  </tbody>
                ...
                <!--deleted--->
                  <?php
                    if(isset($_GET['kode_buku'])){
                        ...
                        echo "<script>location='petugas.php?halaman=buku';</script>";
                    }
                  ?>
...
<?php
    if(isset($_POST['tambah'])){
        ...
        if(mysqli_num_rows($cek) == 0){
          ...
          if($sql){
            echo '<script>alert("Berhasil menambahkan data."); document.location="petugas.php?halaman=buku";</script>';
          }else{
...
-------------------------------------------------------------------------------------------------------------------------------------->
    ...
    if(isset($_POST['edit'])){
      ...
      else
      {
        ...
        if($query){
            echo "<script>alert('Berhasil Mengubah Data!'); window.location.href='petugas.php?halaman=buku';</script>";
        }else{
