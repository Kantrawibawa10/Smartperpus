          ...
          <div class="card-body">
            ...
            <div class="dropdown">
              <a class="btn btn-secondary dropdown-toggle p-0 bg-transparent border-0 text-dark shadow-none font-weight-medium" href="#" role="button" id="dropdownMenuLinkA" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <h5 class="mb-0 d-inline-block">Keterlambatan</h5>
              </a>
              <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkA">
                <a class="dropdown-item" href="petugas.php?halaman=peminjaman">Peminjaman</a>
              </div>
            </div>
              ...
              <table id="recent-purchases-listing" class="table">
                ...
                ?>
                  <tr>
                      ...
                      <td>Dipinjam</td>
                      <td>
                        <a href="pindah_data1.php?id=<?php echo $data['id']; ?>" class="icon-aksi bg-warning">Dikembalikan</a>
                      </td>
                  </tr>
                  <?php } ?>
                </tbody>
...
if($sql) {
    echo "<script>alert('Berhasil Meminjam buku'); window.location.href='petugas.php?halaman=peminjaman';</script>";
}
else {
