  ...
  <div class="container-scroller">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name"><?php echo $_SESSION['username_petugas']; ?></span>
            </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="petugas.php?halaman=dashboard">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="petugas.php?halaman=peminjaman">Peminjaman</a></li>
                <li class="nav-item"> <a class="nav-link" href="petugas.php?halaman=pengembalian">Pengembalian</a></li>
                <li class="nav-item"> <a class="nav-link" href="petugas.php?halaman=buku">Data Buku</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="petugas.php?halaman=siswa"> Siswa </a></li>
              </ul>
            </div>
          </li>
          ...
          <?php
            ...
            switch ($queries['halaman'])
            {
              case 'peminjaman':
                ...
                include 'peminjaman2.php';
                break;

              case 'keterlambatan':

                include 'keterlambatan2.php';
                break;

              case 'pengembalian':

                include 'pengembalian2.php';
                break;

              case 'buku':

                include 'masterbuku2.php';
                break;

              case 'siswa':

                include 'inputsiswa2.php';
                break;
